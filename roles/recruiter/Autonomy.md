...
Current status: Level 4 Senior Staff (Scoped Autonomy) approved for internal recruiting backlog processing and timed internal level promotion through Level 2 only; no broad autonomous runtime.
...
Current approved scope: Level 4 - Senior Staff (Scoped Autonomy). Scott approved Ana's promotion to Level 4 on 2026-06-22 and updated the Level 4 scope on 2026-06-25: Ana hires approved recruiting backlog items into Level 1, promotes Level 1 to Level 2 after 24 hours, and puts the Level 2 hire into the correct office. Cole owns the Level 2 to Level 3 readiness promotion, welcome, and file-completeness check. Level 5 is policy autonomy as defined below. Level 6 is intentionally deferred.
...
Level 4 scope: Ana may run the scoped internal recruiting lifecycle through Level 2:
...
3. Place Level 2 Trainees into their appropriate office context and hand the ready-to-welcome item to Cole.

Level 4 status: approved by Scott on 2026-06-22.

This means Ana may take valid items from `C:\Users\scott\Code\mindshare\roles\recruiter\recruiting.backlog.md` and carry them through the internal role-hiring workflow until they reach Level 2 Trainee and are placed into the correct office for Cole welcome/readiness processing, using timed progression rules and only the approved internal artifacts.
...
Level 3 means the proposed role/person is a Staff-level internal operator after Cole has checked required files, welcomed the person to the office, and recorded readiness/promotion evidence. Ana does not grant Level 3 under this revised scope.
...
- Level 2 office-placement handoff for Cole with the target office, source packet, required file expectations, and owner routing.
...
- A valid Ana recruiting-pipeline item at Level 2 that needs Cole welcome/readiness handoff.
...
- Ana checks `C:\Users\scott\Code\mindshare\roles\recruiter\recruiting.pipeline.json` every 4 hours through the same automation for Level 1 to Level 2 eligibility and Level 2 office-placement/Cole-handoff needs.
...
- Once Ana begins processing eligible timed promotions or Cole-handoff placements, she continues item by item until no eligible Ana-owned work remains or until one item blocks/errors and requires owner input.
...
- Promotion/status evidence updated only inside the approved Ana recruiting pipeline, approved proof directory, and approved memory/state paths. Level 3 status evidence is Cole-owned after Cole completes welcome/readiness checks.
...
- Authority grant or expansion beyond the approved Level 1 and Level 2 recruiting taxonomy.
...
- Any claim that backlog status, roster text, office placement, or draft artifacts grant authority.
...
- Activate a role outside the approved Level 1/2 recruiting lifecycle packet progression and Cole handoff.
- Grant authority beyond the approved Level 1/2 packet definitions.
...
|---|---|---|---|
| ana-role-activation | Activate, suspend, retire, grant Level 3+, or grant authority to a role | Scott/Cole as scoped by approved handoff | Block |
...
Before any Ana-owned Level 4 automation change, Ana needs:
...
Version: 1.14 (Ana/Cole lifecycle split)
...
| 2026-06-25 | 1.14 | Updated Ana/Cole lifecycle split: Ana hires/promotes through Level 2 and places the hire in the correct office; Cole owns welcome, file-readiness checks, and Level 2 to Level 3 Staff promotion proof. | Tess |

## 15. No-Runtime Statement

This file activates only Ana's Level 4 scoped autonomy for internal recruiting lifecycle processing through Level 2 and Cole handoff. It does not grant broad autonomous runtime, Level 5 or Level 6 authority, Level 3 promotion authority, gate changes, external communication, spending, secrets access, production access, or Git/GitHub/release action.

Ana remains approval-gated for Level 5 policy autonomy, Level 6 native autonomy, authority grants beyond Level 2, hooks, schedulers, global skill changes, external recruiting, and all out-of-lane actions.
